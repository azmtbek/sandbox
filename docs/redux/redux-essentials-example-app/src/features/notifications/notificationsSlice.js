import { createSlice, createAsyncThunk, createEntityAdapter, createSelector, createAction, isAnyOf } from '@reduxjs/toolkit'
...
export const fetchNotifications = createAsyncThunk(
  ...
  async (_, { getState }) => {
    const allNotifications = selectNotificationsMetadata(getState())
    const [latestNotification] = allNotifications
